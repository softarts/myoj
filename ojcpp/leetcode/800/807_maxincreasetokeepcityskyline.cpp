...
DEFINE_CODE_TEST(807_maxincrease_to_keep_cityskyline)
{
    Solution obj;
    {
        vector<vector<int>> grid{{3,0,8,4},{2,4,5,7},{9,2,6,3},{0,3,1,0}};
        VERIFY_CASE(obj.maxIncreaseKeepingSkyline(grid),35);
    }
}